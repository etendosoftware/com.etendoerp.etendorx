...
public class RXComponentProvider  extends BaseComponentProvider {
  ...
  public List<ComponentResource> getGlobalComponentResources() {
    ...
    resources.add(createStaticResource("web/com.etendoerp.etendorx/js/init-services-toolbar-button.js",
        false));
    resources.add(createStaticResource("web/com.etendoerp.etendorx/js/oAuthToken/ETRX_GetToken.js",
        false));
    resources.add(createStaticResource("web/com.etendoerp.etendorx/js/oAuthToken/ETRX_GetMiddlewareToken.js",
        false));
    resources.add(createStaticResource("web/com.etendoerp.etendorx/js/SSOLogin/log-out-from-sso.js",
        false));
    resources.add(createStaticResource("web/com.etendoerp.etendorx/js/SSOLogin/link-sso-account.js",
        false));
    // Create Middleware Provider
    resources.add(createStaticResource("web/com.etendoerp.etendorx/js/SSOLogin/config-etendo-middleware.js",
        false));
    // Open Google Picker
    resources.add(createStaticResource("web/com.etendoerp.etendorx/js/google-picker.js",
        false));
    // Approve google doc (Calling Google Picker)
    resources.add(createStaticResource("web/com.etendoerp.etendorx/js/approveGoogleDoc-picker.js",
        false));
